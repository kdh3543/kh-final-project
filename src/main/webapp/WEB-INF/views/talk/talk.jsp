                  ...
                  <div>
                    ...
                    <div class="btn-group">
							...
							<ul class="dropdown-menu">
								...
								<!-- Dropdown menu links -->
								<li>
								 	<button type="button" id="chatDelBtn${delCount.count}" value="${list.roomId}" pid=${list.roomId} class="delBtnClass">삭제</button>
								 </li>
							</ul>
						</div>
                  </div>
				...
				<c:when test="${roomId == 0}">
					<div class="talk-right">
						...
						<div class="right-bottom">
							<input type=text placeholder="이 페이지는 입력할 수 없는 페이지입니다."
								id="preventInput" disabled>
