						...
						<a class="talk-list-btn"
							...
							<div class="talk-list-right">
								...
								<div class="talk-last-conversation" pid=${list.productId}>
									(${list.roomId})${list.lastMessage} <input type=hidden
										value="${list.roomId }" id="hiddenRoomId"
										class="hiddenRoomId${delCount.count}" pid=${list.productId}>
									<input type=hidden value="${list.productId }"
										id="hiddenProductId"> <input type=hidden
										value="${list.sellerId}" id="hiddenSellerId"> <input
										type=hidden value="${list.productName}" id="hiddenProductName">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item" id="modifyBoard">수정</a> 
										<a class="dropdown-item">
											<button type="button" class="chatDelBtn${delCount.count}"
												value="${list.roomId }">X</button></a>
									</li>
								</ul>
							</div>
				...
				<div class="right-top">
					<div class="right-title-left">
						...
						<div class="title-name">
							${productName} <input type=hidden value="${productId}"
								id="productId">
						</div>
					...
					<c:when test="${roomId == 0}">
						<div class="right-middle">
							<div class="initial-page">
								<div class="line">테스트 중입니다.</div>
							</div>
						</div>

						<div class="right-bottom">
							<input type=text placeholder="입력하지 못합니다" id="preventInput"
								disabled>
