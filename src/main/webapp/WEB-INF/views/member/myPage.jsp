			...
			<section class="section2">
				...
				<div class="tab-content" id="nav-tabContent">
						...
						<div class="profile-content">
							...
							<div class="profile-content-section">
								<table class="profile-table">
									<tr>
										<td>아이디</td>
										<td><input type="text" class="inputId" value="${dto.id }"
											disabled></td>
									</tr>
									<tr>
										<td>비밀번호</td>
									...
									<tr>
										...
										<td><input type="text" class="inputZipcode"
											value="${dto.zipcode }">
											<button type="button" class=" btn btn-lg btn-light"
												id="seachAddress">주소 검색</button></td>
									</tr>
									<tr>
										<td>주소1</td>
										<td><input type="text" class="inputAddress1"
											value="${dto.address1 }" disabled></td>
									</tr>
									<tr>
										<td>주소2</td>
										<td><input type="text" class="inputAddress2"
											value="${dto.address2 }" disabled></td>
									</tr>
									<tr>
										<td colspan="2">
					...
					<div class="tab-pane fade" id="nav-sell" role="tabpanel"
						...
						<div class="sell-top">판매내역 ${icnt }건</div>
								...
								<c:forEach var="i" items="${ilist}">
									<c:forEach var="f" items="${flist }">
										...
										<c:if test="${f.parentSeq == i.iseq}">
											<tr>
												 <!-- 상품이미지 태그안에 css적용해놓음 -->
												<td><a href="/items/itemsDetail?seq=${i.iseq}"><img src="${f.sysName}" class="itemImg"
							...
							<table>
								...
								<tr>
									...
									<th>
										...
										<button class=" btn btn-lg btn-light" id="readReviewBtn"
											hidden>후기작성완료</button>
									</th>
								</tr>
							</table>
						</div>
