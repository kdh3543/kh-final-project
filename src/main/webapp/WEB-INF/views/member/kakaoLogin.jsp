...
<body>
    ...
    <main>
    <form action="/member/kakaosignup" method="post">
        <div class="join-wrap">
            <div class="join-title">추가 정보 입력</div>
            <hr>
            <div class="mb-3">
            <label for="inputId" class="form-label">프로필사진</label>
            <input type="text" class="form-control" id="profile_image" name="profile_image" value="${profile_image }" readonly>
            
          </div>
          <div class="mb-3">
            <label for="inputId" class="form-label">사용할 아이디</label>
          ...
          <div class="btnDiv">
            <button id="joinBtn" class="btn btn-lg btn-light" type="submit">제출</button>
