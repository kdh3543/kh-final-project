										 ...
										 $("#search").one("click",function(){ 
											...
											$.ajax({
												...
												/*  $.each(arr, function(index, item)
													 ...
													 console.log(item); */
													/* var result = ' ';
													result += index + ' : ' + item.keyword+ ' , ' + item.write_time;
													console.log (result[]); */

												/* 	var result = "";
																								
												 document.getElementsByClassName('searchList')[index].innerHTML = item.keyword + " : " + item.write_time; 	  */
												 /* <a class="dropdown-item searchList" href="#" style = "display:float:left" ></a> */
